...
$.NavigationBar.custom.addEventListener("click", function(_event) {
	...
	dialog.addEventListener("click", function(_event) {
		switch(mapping[_event.index]) {
			case "facebook":
				APP.log("trace", "blog_article @menu_facebook")
				SOCIAL.facebook(ACTION.url);
				break;
			case "twitter":
				APP.log("trace", "blog_article @menu_twitter")
				SOCIAL.twitter(ACTION.url);
				break;
			case "email":
				APP.log("trace", "blog_article @menu_email")
				SOCIAL.email(ACTION.url);
				break;
			case "safari":
				APP.log("trace", "blog_article @menu_safari")
				Ti.Platform.openURL(ACTION.url);
				break;
			case "safari":
				APP.log("trace", "blog_article @menu_cancel")
				break;
		}
	});
